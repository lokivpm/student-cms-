# Generated by Django 4.2.6 on 2023-11-16 10:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_messages_admin', to='api.customuser')),
                ...
                ('sender_admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sent_messages_admin', to='api.customuser')),
